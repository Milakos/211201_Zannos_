...
Με την ίδια λογική καθορίζεται στην συνέχεια και το Reverb, όπου διαχειρίζονται τιμές όπως ο χρόνος αντήχησης, η ένταση, ένα low pass filter, το predelay, καθώς και την αναλογία του καθαρού σήματος με το σήμα που περνάει από το εφέ (dry/wet). Το Reverb το εισέρχεται σε ένα Bus για μελλοντική χρήση. 
